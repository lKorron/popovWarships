...
class Ship:
    ...
    def choose_direction_based_on_vision(self, grid):
        ...
        if friendly_strength > enemy_strength:
            ...
            return max(escape_counts, key=escape_counts.get)

class OurShip(Ship):
    def __init__(self, color=(0, 0, 255), speed=1, vision_range=3, attack_range=3, health=100, power=10, accuracy=0.7, attack_delay=30):
        super().__init__(color, speed, vision_range, attack_range, health, power, accuracy, attack_delay)
        self.ship_type = "our"

class EnemyShip(Ship):
    def __init__(self, color=(255, 0, 0), speed=1, vision_range=3, attack_range=3, health=100, power=10, accuracy=0.7, attack_delay=30):
        super().__init__(color, speed, vision_range, attack_range, health, power, accuracy, attack_delay)
...
# our_ship3 = OurShip(speed=40, attack_delay=10)
#
#
# grid.add_ship_from_cell(0, 10, our_ship1)
# grid.add_ship_from_cell(1, 10, our_ship2)
# grid.add_ship_from_cell(2, 10, our_ship3)
